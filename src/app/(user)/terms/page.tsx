        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            <section className="space-y-4">
              ...
              <p>
                Chào mừng bạn đến với MarketTrend. Bằng cách truy cập và sử dụng website của chúng tôi, 
            ...
            <section className="space-y-4 mt-8">
              ...
              <p>
                ...
                MarketTrend và được bảo vệ bởi luật bản quyền quốc tế.
              </p>
            </section>
            ...
            <section className="space-y-4 mt-8">
              ...
              <p>
                Trong mọi trường hợp, MarketTrend sẽ không chịu trách nhiệm về bất kỳ thiệt hại nào 
