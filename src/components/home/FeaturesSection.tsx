  ...
  return (
    <section className="py-12 sm:py-16 bg-accent/10">
      <div className="container max-w-5xl mx-auto px-4">
        <div className="relative bg-gradient-to-br from-background to-accent/20 rounded-2xl p-8 md:p-10 border border-gray-200 shadow-lg">
          <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-transparent opacity-50" />
          <div className="relative flex flex-col items-center">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-10">Chức năng chính</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
              {features.map((feature) => (
                <Link
                  key={feature.title}
                  href={feature.href}
                  className="group relative flex flex-col items-center text-center p-6 rounded-lg bg-gradient-to-br from-background via-accent/5 to-accent/10 hover:from-background hover:via-accent/10 hover:to-accent/20 border border-gray-200 transition-colors duration-200 hover:shadow-sm will-change-transform"
                >
                  ...
                  <div className="relative z-10 flex flex-col items-center w-full">
                    <div className="w-16 h-16 flex items-center justify-center mb-4">
                      <feature.icon className="w-10 h-10 text-primary transition-transform duration-200 will-change-transform group-hover:scale-110" />
                    </div>
                    <h3 className="text-lg font-semibold mb-3">{feature.title}</h3>
                    <div className="flex items-center justify-center text-primary font-medium mb-3 group-hover:text-primary/80 transition-colors duration-200">
